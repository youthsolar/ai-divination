...
4. **If Fix Doesn't Work** - STOP. Count: How many fixes tried? If ≥ 3: question architecture.
5. **If 3+ Fixes Failed: Question Architecture** - Stop and discuss with human before attempting more fixes.
